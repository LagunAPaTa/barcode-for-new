...
class PluginBarcodeConfig extends CommonDBTM {
   ...
   function showForm($ID, array $options = []) {
      ...
      // Display UTF-8/Chinese support status
      $unicodeSupport = PluginBarcodePdfHelper::checkUnicodeSupport();
      $statusClass = $unicodeSupport['supported'] ? 'green' : 'orange';
      echo "<tr class='tab_bg_1'>";
      echo "<th colspan='4'>".__('UTF-8 & Chinese Character Support', 'barcode')."</th>";
      echo "</tr>";
      echo "<tr class='tab_bg_1'>";
      echo "<td colspan='4' align='center' style='color: $statusClass;'>";
      echo "<i class='fas fa-".($unicodeSupport['supported'] ? "check-circle" : "exclamation-triangle")."'></i> ";
      echo $unicodeSupport['message'];
      echo "<br><small>".__('For best Chinese character support, use QR codes instead of barcodes.', 'barcode')."</small>";
      echo "</td>";
      echo "</tr>";
